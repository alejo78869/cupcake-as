Documentação Oficial do Projeto – Cupcake AS
Cupcake AS – Sistema Web de Cupcakes
Aluno: Javier Alejandro Salvador Lopez RGM: 29544874 Curso: Análise e Desenvolvimento de Sistemas
...
Foram realizados 5 testes com usuários fictícios para avaliar a interface e funcionalidade. Principais pontos corrigidos:
...
Documentação no GitHub Pages: (opcional)
